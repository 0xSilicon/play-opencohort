...
class Utils {
    ...
    getSiliconProtocolManagerABI() {
        return this.getABI("SiliconProtocolManager");
    }
    ...
    makeRemoveAllMembersHash(dto) {
        ...
        const dataBytes = defaultAbiCoder.encode(
            ...
            ['OpenCohort:RemoveAll', cohort, chainId, cohortId, validUntil]
        );
        return keccak256(dataBytes);
    }
